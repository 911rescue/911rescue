...
var SecureProperties = function (_Component) {
  ...
  _createClass(SecureProperties, [{
    ...
    value: function requestEmergencyResponders() {
      var myPhone = window.btoa(JSON.stringify({
        params: {
          phoneNumber: '+19173010220'
        }
      }));
      _axios2.default.get('/api/emergency/' + myPhone).then(function (response) {
...
//# sourceMappingURL=0.ba9d0132f1d32028ce96.hot-update.js.map